...
namespace Rhymix\Modules\Assetbox\Models;
...
class Config
{
	...
	public static function getConfig()
	{
		if (self::$_cache === null)
		{
			self::$_cache = ModuleModel::getModuleConfig('assetbox') ?: new \stdClass;
		}
		return self::$_cache;
	}
	...
	public static function setConfig($config)
	{
		...
		$result = $oModuleController->insertModuleConfig('assetbox', $config);
		if ($result->toBool())
		{
			self::$_cache = $config;
		}
